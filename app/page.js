    ...
    <div className="">
      <div className="flex flex-col justify-center items-center gap-4 h-[60vh]">
        ...
        <div className="flex justify-center items-center gap-5">
          <button type="button" className="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-slate-800 font-medium rounded-lg text-sm px-5 py-2 text-center hover:cursor-pointer">Start Here</button>
          <button type="button" className="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-slate-800 font-medium rounded-lg text-sm px-5 py-2 text-center hover:cursor-pointer">Read More</button>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-10 justify-center items-center py-15 h-[55vh]">
